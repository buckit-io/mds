...
const TenantsOutlineIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g data-name="Tenants Outline" clipPath="url(#prefix__a)">
      ...
      />
      <path data-name="Rect\xE1ngulo 865" fill="none" d="M0 0h256v256H0z" />
    </g>
  </svg>
);
